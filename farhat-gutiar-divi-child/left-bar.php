...
// get all bands
$all_bands = new_get_all_bands(-1, 'post_title','ASC', tru);
?>


<ul  class="sidebar-menu">
    <li class="header">
      <a href="#" onclick="$('#paypal-1').click()"><i class="fa fa-paypal"></i> <span><?php _e('Donate', 'farhat'); ?></span>
      </a>
    </li>
  ...
  if (isset($tabs_link)) {
    ...
    <li class="header">
      <a href="<?php echo $tabs_link ?>"
         target="_blank"><i class="fa fa-download"></i> <span><?php _e('DOWNLOAD TABS (PDF)', 'farhat'); ?></span>
      </a>
    </li>
