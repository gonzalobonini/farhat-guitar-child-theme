			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class( 'et_pb_post' ); ?>>
                        <?php
                            $debug = false;
                            $is_lesson = true;
                            $song_id = get_post_meta( get_the_ID(), 'lesson_song_id', true );
...
//                            );
                            ...
                            $cart_link = get_post_meta( get_the_ID(), 'lesson_cart_link', true );
                            $tabs_link = get_post_meta( get_the_ID(), 'lesson_download_tabs', true );
                            $video_link = get_post_meta( get_the_ID(), 'lesson_video', true );
